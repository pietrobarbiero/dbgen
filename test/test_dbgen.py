...
class Test(unittest.TestCase):
    def test_dbgen(self):
        ...
        res0 = dbgen.Sample.get_results(species_name="species2", dataset_name="2009_AuthorName3")
        res1 = dbgen.Sample.get_results(species_name="species2")
        res2 = dbgen.Sample.get_results(dataset_name="2009_AuthorName3")
        ...
        self.assertTrue(s3.shape == (191, 4))
        self.assertTrue(u1.shape == (92, 4))
        self.assertTrue(u2.shape == (191, 4))
